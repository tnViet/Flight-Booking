...
<!-- Deals Section -->
<div class="section-container" style="padding: 0 48px 48px;">
    <h2 class="section-title">Chuyến bay giá tốt</h2>

    <div class="carousel-wrapper">
        <button id="prevBtn" class="carousel-nav" id="prevBtn">
        ...
        <button class="carousel-nav" id="nextBtn">
...
.carousel-nav {
    ...
    border-radius: 50%;
    background: white;
    border: 1px solid var(--theme_border, #ddd);
    box-shadow: 0 2px 8px rgba(0,0,0,0.1);
    cursor: pointer;
    display: flex;
    align-items: center;
    justify-content: center;
    color: var(--theme_blue, #1a56db);
    transition: all 0.2s;
}
.carousel-nav:hover {
    background: var(--theme_blue, #1a56db);
    color: white;
    border-color: var(--theme_blue, #1a56db);
}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function visibleCount() {
        // viewport width đã chính xác vì carousel-wrapper dùng flexbox
